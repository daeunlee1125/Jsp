	...
	<head>
		...
		<!-- 
			...
			배포
			 ...
			 - C:\Users\GGG\apache-tomcat-10.1.43 실행
			 - C:\Users\GGG\apache-tomcat-10.1.43\webapps 폴더에 배포파일(ch10.war) 업로드 후 잠깐 기다리기
			 - Deploy 확인 후 브라우저 확인
		 -->
	</head>
	<body>
		...
		<h4>Bank</h4>
		<a href = /ch10/college/student/list.do>Account CRUD</a>
		<a href = /ch10/college/student/list.do>Customer CRUD</a>
		
		<h4>Library</h4>
		<a href = /ch10/college/student/list.do>Member CRUD</a>
		<a href = /ch10/college/student/list.do>Book CRUD</a>
